...
for (let i = 0; i < simpsons.length; i++) {
    document.write(`<div class="divStyle"> NAME-${simpsons[i].name} <br>SURNAME-${simpsons[i].surname} <br>AGE-${simpsons[i].age} <br>INFO-${simpsons[i].info} <img src="${simpsons[i].photo}" class="divStyleImg" alt=""></div>`);
}
document.write(`<h2>Template 2.2</h2>`);
for (let i = 0; i < simpsons.length; i++) {
    document.write(`<div class="divStyle2"><h2>${simpsons[i].name} ${simpsons[i].surname}. Age is-${simpsons[i].age}</h2>
 <p>${simpsons[i].info}</p>
 <img src="${simpsons[i].photo}" class="divStyle2Img" alt=""></div>`);
}
//------------------------------------------->
//
//     <!--        template 3.1-->
...
document.write(`<div class="wrapProduct-card">`);
for (let i = 0;i<products.length;i++) {
    document.write(`<div class="product-card"><h3 class="product-title">${products[i].title} Price - ${products[i].price}</h3>
