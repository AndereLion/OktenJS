...
// которая имеет детальную информацию про объект на который кликнули
            let buttonToUserDetails = document.createElement('button');
            buttonToUserDetails.innerText = 'User details';
            divForUser.appendChild(buttonToUserDetails);
            buttonToUserDetails.addEventListener('click', () => {

                localStorage.setItem('userTarget', JSON.stringify(user));
...
// вывести все комментарии текущего поста (эндпоинт для получения информации - https://jsonplaceholder.typicode.com/posts/POST_ID/comments)
//DONE
// Стилизация проекта -
...
// Все без исключения элементы,
// который характеризируют user,post,comment  визуализировать,
